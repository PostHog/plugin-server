...
import { createJobs } from '../../worker/vm//extensions/jobs'
import { createCache } from '../../worker/vm/extensions/cache'
import { createConsole } from '../../worker/vm/extensions/console'
import { createGeoIp } from '../../worker/vm/extensions/geoip'
import { createGoogle } from '../../worker/vm/extensions/google'
import { createPosthog } from '../../worker/vm/extensions/posthog'
import { createStorage } from '../../worker/vm/extensions/storage'
import { imports } from '../../worker/vm/imports'
import { transformCode } from '../../worker/vm/transforms'
import { upgradeExportEvents } from '../../worker/vm/upgrades/export-events'

// TODO(nk): Find a way to repeat myself less - can add param to run setup. Much better than this shit.
